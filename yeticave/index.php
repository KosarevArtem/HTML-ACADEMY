...
<main class="container">
    <section class="promo">
        ...
        <ul class="promo__list">
            <?php foreach($cats as $modifier => $cat): ?>
        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?= $product["item_url"]; ?>" width="350" height="260" alt="<?= $product["item_name"]; ?>">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?= $product["item_cat"]; ?></span>
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?= $product["item_name"]; ?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?= $product["item_price"]; ?></span>
                        </div>
