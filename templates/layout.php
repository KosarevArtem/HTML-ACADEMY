...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <form class="main-header__search" method="get" action="search.php" autocomplete="off">
            <input type="search" name="search" placeholder="Поиск лота" <?php if (isset($_GET['search'])): ?>value="<?=$search_text?>" <?php endif; ?>>
...
<footer class="main-footer">
    <nav class="nav">
        <ul class="nav__list container">
            ...
            <li class="nav__item">
                <a href="all-lots.php?category=<?=$cat["id"]?>"><?= $cat["cat_name"]; ?></a>
            </li>
            <?php endforeach; ?>
        </ul>
    </nav>
